                        ...
                        <nav>
                            <ul>
                                ...
                                <li class="msg-trigger navabar01"><a class="msg-trigger-btn" href="#a">message</a>
                                 ...
                                 <li class="navabar01"><a href="{{asset('notifications')}}">Notification</a></li>
                                <li class="request-trigger navabar01"><a class="msg-trigger-btn" href="#c">request</a>
            ...
            <div class="mobile-menu w-100">
                <ul>
                    <li>
                        ...
                        <ul class="frnd-request-list border" style="margin-bottom: 0">
                            @foreach ($friend as $key => $value)
                            <li>
...
{{-- Message box start --}}
        ...
        <input type="text" id="textMessages" name="usrname">&nbsp;
        <input type="submit" placeholder="Send" value="send" id="sendMessage">
